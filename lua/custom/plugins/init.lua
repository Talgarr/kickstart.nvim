...
-- Add reset view to middle when up and down with CTRL
vim.keymap.set('n', '<C-j>', 'jzz', { desc = 'Move down and center the view' })
vim.keymap.set('n', '<C-k>', 'kzz', { desc = 'Move up and center the view' })
